...
export default function DashboardMockup() {
  return (
    <section className="py-32 relative overflow-hidden bg-heso-dark border-y border-white/5">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Controle gerencial em <span className="text-gradient">frações de segundo</span>.
          </motion.h2>
        </div>

        {/* Big Dashboard Mockup Window */}
        <motion.div 
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="w-full max-w-5xl rounded-3xl bg-[#6D28D9]/5 border border-[#6D28D9]/20 backdrop-blur-sm shadow-2xl overflow-hidden"
        >
          {/* Top Bar */}
          <div className="h-14 border-b border-white/10 flex items-center justify-between px-4 bg-white/5">
            ...
            <div className="flex px-4 items-center h-8 bg-black/40 border border-white/5 rounded-md w-96 text-xs text-white/30 gap-2">
              <Search className="w-3 h-3" /> Buscar métricas...
            </div>
            
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-heso-purple/20 border border-heso-purple/50 flex items-center justify-center text-xs font-bold text-heso-purple">
                A
              </div>
            </div>
          </div>
          ...
          {/* Dashboard Content */}
          <div className="p-8 grid grid-cols-12 gap-6 bg-transparent">
            {/* Header Area */}
            <div className="col-span-12 flex justify-between items-center mb-4">
              <div>
                <h3 className="text-2xl font-bold">Visão Geral</h3>
                <p className="text-xs text-white/50 mt-1">Atualizado há 2 minutos</p>
              </div>
              <div className="flex gap-2">
            ...
            <div className="col-span-12 md:col-span-4 bg-white/5 p-6 rounded-xl border border-white/5 relative overflow-hidden group">
               ...
               <DollarSign className="w-6 h-6 text-heso-purple mb-4" />
               <div className="text-[10px] text-gray-400 uppercase mb-1">Faturamento Trimestre</div>
            ...
            <div className="col-span-12 md:col-span-4 bg-white/5 p-6 rounded-xl border border-white/5">
               ...
               <div className="text-[10px] text-gray-400 uppercase mb-1">Uptime</div>
            ...
            <div className="col-span-12 md:col-span-4 bg-white/5 p-6 rounded-xl border border-white/5">
               ...
               <div className="text-[10px] text-gray-400 uppercase mb-1">Tasks</div>
            ...
            <div className="col-span-12 lg:col-span-8 bg-white/5 p-6 rounded-2xl border border-white/5 h-80 flex flex-col relative overflow-hidden">
              ...
              <div className="flex-1 w-full relative">
                 <svg className="w-full h-full opacity-50" viewBox="0 0 100 40" preserveAspectRatio="none">
                   <path d="M0 35 Q 10 32, 20 38 T 40 25 T 60 30 T 80 15 T 100 20" stroke="#6D28D9" fill="none" strokeWidth="1.5" />
              ...
              <div className="absolute bottom-4 left-6 flex gap-6">
                 <div className="flex items-center gap-2 text-[10px] text-gray-400"><div className="w-2 h-2 rounded-full bg-[#6D28D9]"></div> Growth</div>
            ...
            <div className="col-span-12 lg:col-span-4 bg-white/5 p-6 rounded-2xl border border-white/5 flex flex-col">
              <div className="text-sm font-semibold mb-6 flex justify-between">
                ...
                <span className="text-heso-purple text-xs cursor-pointer">Ver todas</span>
              </div>
