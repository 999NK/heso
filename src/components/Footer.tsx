      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="https://wa.me/5535991319992" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-[#6D28D9] transition-colors">WhatsApp: (35) 99131-9992</a>
            <div className="flex gap-4 mt-2">
              ...
              <a href="https://instagram.com/hydracode.dev" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 transition-colors" title="@hydracode.dev">
                 <span className="sr-only">Instagram @hydracode.dev</span>
